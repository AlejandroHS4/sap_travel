CLASS lcl_buffer DEFINITION.
    ...
    PUBLIC SECTION.
        ...
        TYPES: BEGIN OF ty_buffer_master.
                INCLUDE TYPE zhcm_master_a02 AS data.
...
CLASS lhc_HCMMaster IMPLEMENTATION.
  ...
  METHOD create.
    ...
    SELECT MAX( e_number ) FROM zhcm_master_a02
        INTO @DATA(lv_max_employee_number).

    LOOP AT entities INTO DATA(ls_entities).
        ls_entities-crea_date_time = lv_time_stamp.
        ls_entities-crea_uname     = lv_uname.
        ls_entities-e_number       = lv_max_employee_number + 1.
  ...
  METHOD update.
    ...
    SELECT SINGLE * FROM zhcm_master_a02
        INTO @DATA(lv_max_employee_number).
...
CLASS lsc_HCMMaster IMPLEMENTATION.
  ...
  METHOD save.
    ...
    DATA: lt_data_created TYPE STANDARD TABLE OF zhcm_master_a02,
          lt_data_updated TYPE STANDARD TABLE OF zhcm_master_a02,
          lt_data_deleted TYPE STANDARD TABLE OF zhcm_master_a02.
    ...
    IF NOT lt_data_created IS INITIAL.
        INSERT zhcm_master_a02 FROM TABLE @lt_data_created.
    ...
    IF NOT lt_data_updated IS INITIAL.
        UPDATE zhcm_master_a02 FROM TABLE @lt_data_updated.
        CLEAR lcl_buffer=>mt_buffer_master.
    ENDIF.
    ...
    IF NOT lt_data_deleted IS INITIAL.
        DELETE zhcm_master_a02 FROM TABLE @lt_data_deleted.
        CLEAR lcl_buffer=>mt_buffer_master.
    ENDIF.
