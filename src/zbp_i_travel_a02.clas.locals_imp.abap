...
CLASS lhc_Travel IMPLEMENTATION.
    ...
    LOOP AT lt_travel ASSIGNING FIELD-SYMBOL(<ls_travel>).
      ...
      IF <ls_travel>-customer_id IS INITIAL
        ...
        APPEND VALUE #( travel_id = <ls_travel>-travel_id
                        %msg      = new_message( id        = 'Z_MC_TRAVEL_A02'
                                                  number   = '001'
  ...
  METHOD validateDates.
    ...
    READ ENTITY z_i_travel_a02\\Travel
    ...
    LOOP AT lt_travel_result INTO DATA(ls_travel_result).
      ...
      IF ls_travel_result-end_date LT ls_travel_result-begin_date. "end_-date before begin_date
...
*
*    IF lv_user EQ 'CB9980000572'.
*        lv_authh = if_abap_behv=>auth-allowed.
*    ELSE.
*        lv_authh = if_abap_behv=>auth-unauthorized.
*    ENDIF.
*
    DATA(lv_auth) = cond #( when cl_abap_context_info=>get_user_technical_name(  ) eq 'CB9980000572'
...
* Modify in local mode - BO - related updates there are not relevant for authorization objects
    MODIFY ENTITIES OF z_i_travel_a02  IN LOCAL MODE
           ENTITY Travel
    ...
    READ ENTITIES OF z_i_travel_a02 IN LOCAL MODE
        ENTITY Travel
        FIELDS ( agency_id
                 customer_id
                 begin_date
...
*    reported reported.
    ...
    DATA lt_create_travel TYPE TABLE FOR CREATE z_i_travel_a02\\Travel.

    SELECT MAX( travel_id ) FROM ztravel_a02
